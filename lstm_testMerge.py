...
def main():
    time1 = time.time()
    train_sets = AllData(foldname='./data/train2/', max_seq=max_seq, num_class=n_classes)
    test_sets = AllData(foldname='./data/test2/', max_seq=max_seq, num_class=n_classes)
