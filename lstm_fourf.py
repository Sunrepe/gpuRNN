...
def main():
    time1 = time.time()
    train_sets = NewDataSetTest3(foldname='./data/actdata/', max_seq=max_seq, trainable=True)
    test_sets = NewDataSetTest3(foldname='./data/actdata/', max_seq=max_seq, trainable=False)
